...
-- CreateEnum
CREATE TYPE "HomeworkStatusStudent" AS ENUM ('PENDING', 'CHECKED', 'RETURNED', 'REJECTED');
...
CREATE TABLE "HomeworkResponse" (
    ...
    "title" TEXT,
    "file" TEXT,
    "status" "HomeworkStatusStudent" NOT NULL DEFAULT 'PENDING',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "url" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Rating_studentId_lessonId_key" ON "Rating"("studentId", "lessonId");
